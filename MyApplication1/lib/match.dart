...
flagWidget: _buildStripedFlag([
Colors.pink, Colors.pink, Colors.purple, Colors.blue, Colors.blue
]),
),
FlagModel(
id: '3',
...
flagWidget: _buildStripedFlag([
Colors.lightBlueAccent, Colors.pinkAccent, Colors.white, Colors.pinkAccent, Colors.lightBlueAccent
]),
),
FlagModel(
id: '5',
...
flagWidget: _buildStripedFlag([
Colors.black, Colors.grey, Colors.white, Colors.purple
]),
),
];
...
child: Opacity(opacity: 0.7, child: flag.flagWidget),
),
...
SnackBar(
content: Text('Correct! That is the ${flag.name} flag.'),
...
ScaffoldMessenger.of(context).showSnackBar(
const SnackBar(
content: Text('Incorrect alignment. Try again!'),
...
: (incoming.isNotEmpty ? Colors.purple.withOpacity(0.2) : Colors.grey.shade900),
borderRadius: BorderRadius.circular(8),
border: Border.all(
color: isMatched
? Colors.green
: (incoming.isNotEmpty ? Colors.purple : Colors.transparent),
width: 2,
),
),
...
style: TextStyle(
fontSize: 14,
color: isMatched ? Colors.green.shade200 : Colors.white,
...
textAlign: TextAlign.center,
  ...
  if (isGameOver) ...[const SizedBox(height: 30),const Text('🎉 Congratulations! 🎉\nYou matched all the flags perfectly!',textAlign: center,style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.green),),const SizedBox(height: 12),ElevatedButton(style: ElevatedButton.styleFrom(backgroundColor: Colors.purple),onPressed: () => setState(() => _resetGame()),child: const Text('Play Again', style: TextStyle(color: Colors.white)),),]],),),);}}