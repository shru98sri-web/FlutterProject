...
class PostProvider extends ChangeNotifier {
  ...
  Future<void> fetchPosts() async {
    ...
    final Uri url = Uri.parse('http://localhost:8080/api/v1/holiday');
  ...
  Widget _buildBody(PostProvider provider) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final String id = post['price'].toString();
        final String userId = post['place'].toString();
         final String title = post['title'] ?? 'Package';
         final String body = post['body'] ?? 'Discount ';
